...
app = Flask(__name__)
cors = CORS(app, recources={
            r'/recommendation/*': {'origins': 'http://localhost:5173'}})
cors = CORS(app, recources={
            r'/diabetes-prediction/*': {'origins': 'http://localhost:5173'}})
cors = CORS(app, resources={
            r'/heart-prediction/*': {'origins': 'http://localhost:5173'}})
